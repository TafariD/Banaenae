...
function getdata(){
  ...
  $.getJSON("food_scores.json", function(jdata) { //code based off of stackoverflow.com/questions/7346563/loading-local-json-file:
    $.each( jdata, function (key, val) {
    $('#data').append("<p>" + " Food Item: " + key + " Upvotes: " + val.toString() + "</p>")
    });
